...
- 2026-09-19 — แสดงคำอธิบายวิดีโอ (`videos.description`) ในรายการคลิปหน้า `/learn/[slug]` — ส่วน "objective" ของข้อ "หน้าคอร์สภาพรวม" (frontend อย่างเดียว ไม่มี migration) — PR เปิดแล้ว รอ merge
