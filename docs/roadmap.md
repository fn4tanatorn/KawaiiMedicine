...
- [x] **แสดง "ดูจบเฉลี่ย" ฝั่งนักเรียน** (คำขอนักเรียน ไม่ได้มาจาก survey) — การ์ดในหน้า
  ...
  นับเฉพาะผู้เรียนที่ดูจบครบทุกคลิปที่ลงแล้ว (นับในตัวหารเสมอ) หรือผู้เรียนที่ยังดูไม่จบแต่เข้าเรียนใน 14 วันล่าสุด
  (`max(video_progress.updated_at) >= now() - interval '14 days'`) — ผู้เรียนที่สมัครแล้วไม่เคยเปิดดูเลย
  หรือผู้เรียนที่ค้างดูไม่จบและหยุดเรียนไปเกิน 14 วันจะไม่ถูกนับเป็น 0 ถ่วงค่าเฉลี่ย 60%
...
- [x] **มุมพักใจ (Lounge / กระดานกำลังใจนิรนาม)** — เมนู `/lounge` บนเว็บ (Semi-private สำหรับผู้เรียนที่เข้าสู่ระบบ)
  เปิดพื้นที่แลกเปลี่ยนเรื่องราว ถามไถ่สารทุกข์สุกดิบ และส่งกำลังใจให้กัน มีโหมดไม่ระบุตัวตนพร้อมสุ่มฉายาน่ารักๆ
  (เช่น แมวส้มอ่านหนังสือ, นากน้อยพักใจ), Mood picker 1 คลิก (พร้อมลุย, แบต 10%, เติมกาแฟ, อยากพักผ่อน, ไฟลุก)
